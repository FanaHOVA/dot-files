...
alias get-instructions='agents-927 ~/instructions.md'
alias cs='claude-squad -p "claude --dangerously-skip-permissions"'

# awt helpers (awt-dev, awt-handoff)
[ -f ~/.awt/helpers.zsh ] && source ~/.awt/helpers.zsh
...
# syntax highlighting now loaded via oh-my-zsh plugin (old standalone install can be removed: rm -rf ~/zsh-syntax-highlighting)

# Override Oh My Zsh's gp alias
...
# pnpm
export PNPM_HOME="/Users/alessiofanelli/Library/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
...
# fzf integration (fuzzy Ctrl+R history search, Ctrl+T file finder)
